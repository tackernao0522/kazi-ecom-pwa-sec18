# セクション 55: Backend Store Review and Site Setting
...
- `resources/views/backend/review`ディレクトリを作成<br>

* `resources/views/backend/review/review_all.blade.php`ファイルを作成<br>

```html:review_all.blade.php
