## 465 Get Product Order Part3

- `resources/views/backend/orders/pending_orders.blade.php`を編集<br>
...
- `resources/views/backend/orders/order_details.blade.php`ファイルを作成<br>
